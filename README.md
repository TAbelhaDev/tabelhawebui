...
| `Landing`            | landing sections as one compound export: `Landing.Hero`, `Landing.Steps` (numbered cards), `Landing.Features`, `Landing.Roadmap`, `Landing.Footer` (`name` + optional `tagline`/`license`/repo link) |
